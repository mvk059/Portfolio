...
sealed interface KenKenGridIntent {
    ...
    data class SetShapeOperation(val operation: KenKenOperation, val shapeId: String) : KenKenGridIntent
    data class SetShapeValue(val value: KenKenCellValue, val shapeId: String) : KenKenGridIntent
